        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-6 flex items-baseline gap-3">
              ...
              <span className="text-3xl font-bold text-zinc-900 dark:text-zinc-100">${product.price}</span>
            ...
            <div className="mt-8 space-y-4 rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
              <h3 className="text-sm font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">{product.description}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm font-medium text-zinc-900 dark:text-zinc-100">{product.stock}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm font-medium text-zinc-900 dark:text-zinc-100">{product.returnPolicy}q</p>
                </div>
              </div>
            </div>
